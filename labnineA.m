 ...
 [BumpRight,BumpLeft,WheDropRight,WheDropLeft,WheDropCaster,BumpFront] = BumpsWheelDropsSensorsRoomba(serPort);
        ...
        elseif BumpLeft
             ...
             elseif BumpFront
                ...
                %add avoid code here using bump sensor rumba 
        end
    ...
    while (Dist1 < 2.3)
        ...
        if ( SonFF(idx1) < 0.31 ) turnAngle(serPort, .2, -70);
        end
    ...
    disp('obstacle in memory detected');
